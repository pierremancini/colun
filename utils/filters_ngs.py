...
def filter_from_regex(dir_to_filter, regex, out_dir='data/unmatched_files'):
...
if __name__ == '__main__':
    ...
    in_dir = sys.argv[1] # Dans data/

    # On supprime les fichiers inutiles
    filtered_dir = remove_useless(in_dir)

    # Renomage "manuel" de fichiers particuliers
    # Nb: Anonymisation, exemples de données uniquement 
    files_to_rename = [('*****_*****- BR90.xls', '*****_*****-BC90.xls'),  
    ('***** ** *** BC32.xls', '*****-*****-BC32.xls')
    ]
